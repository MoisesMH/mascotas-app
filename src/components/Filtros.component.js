...
const FiltrosBusqueda = (props) => {
    ...
    const onClick = () =>{
        ...
        if (filtroEspecie != null){
            arrayFiltros.push({"especie":filtroEspecie})
        }

        if (filtroTamano != null){
            arrayFiltros.push({"especie":filtroTamano})
        }

        if (filtroGenero != null){
            arrayFiltros.push({"especie":filtroGenero})
        }

        if (filtroEdad != null){
            arrayFiltros.push({"especie":filtroEdad})
        }
    }
        ...
        <div className="container">
            ...
            <div className="row card ml-5">
                ...
                <div className="col">
                    ...
                    <button className="btn btn-success m-4">Aplicar Filtros</button>
